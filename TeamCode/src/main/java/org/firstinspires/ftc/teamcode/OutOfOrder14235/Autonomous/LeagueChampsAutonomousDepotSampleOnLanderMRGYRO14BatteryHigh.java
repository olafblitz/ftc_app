...
@Autonomous
public class LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh extends LinearOpMode{
    HardwareRobot robot;
    ...
    public void runOpMode() {
                        ...
                        if (updatedRecognitions.size() == 3) {
                            ...
                            if (goldMineralX != -1 && silverMineral1X != -1 && silverMineral2X != -1) {
                                if (goldMineralX < silverMineral1X && goldMineralX < silverMineral2X) {
                                    position = LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh.MineralPosition.LEFT;
                                    ...
                                    position = LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh.MineralPosition.RIGHT;
                                    ...
                                    position = LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh.MineralPosition.CENTER;
        ...
        if(position == LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh.MineralPosition.LEFT ){

            ShiftRight(.7);
            sleep(650);//changed from 950l battery power vwry i,poprtmnat
            StopDriving();
            DriveForward(1);
            sleep(1400);
            StopDriving();
...
//needs work
        ...
        else if(position == LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh.MineralPosition.RIGHT){
        ...
        else if(position == LeagueChampsAutonomousDepotSampleOnLanderMRGYRO14BatteryHigh.MineralPosition.CENTER){
            ShiftRight(1);
            sleep(3200);
            StopDriving();
            robot.markerDropper.setPosition(1);
